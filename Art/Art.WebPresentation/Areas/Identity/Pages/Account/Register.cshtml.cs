...
namespace Art.WebPresentation.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(IServiceProvider provider)
        {
            _provider = provider;
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                //var userVM = new UsersViewModel { UserName = Input.Email, Email = Input.Email };
                var user = _mapper.Map<Users>(new UsersViewModel { UserName = Input.Email, Email = Input.Email });
                var result = await _userEngine.UsersManager.CreateAsync(user, Input.Password);
                if (result.Succeeded)
                {
