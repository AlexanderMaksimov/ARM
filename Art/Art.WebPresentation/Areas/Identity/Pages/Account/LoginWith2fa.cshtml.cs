...
namespace Art.WebPresentation.Areas.Identity.Pages.Account
{
    ...
    public class LoginWith2faModel : PageModel
    {
        ...
        public LoginWith2faModel(IServiceProvider provider)
        {
            _provider = provider;
        ...
        public async Task<IActionResult> OnGetAsync(bool rememberMe, string returnUrl = null)
        {
            ...
            var user = await _userEngine.SignInManager.GetTwoFactorAuthenticationUserAsync();
        ...
        public async Task<IActionResult> OnPostAsync(bool rememberMe, string returnUrl = null)
        {
            ...
            var result = await _userEngine.SignInManager.TwoFactorAuthenticatorSignInAsync(authenticatorCode, rememberMe, Input.RememberMachine);
